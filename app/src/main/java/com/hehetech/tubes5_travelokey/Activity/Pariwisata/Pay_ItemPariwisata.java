...
public class Pay_ItemPariwisata extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_bayar_konfirmasi) {
            Intent intentSearchFlight = new Intent(Pay_ItemPariwisata.this, Home.class);

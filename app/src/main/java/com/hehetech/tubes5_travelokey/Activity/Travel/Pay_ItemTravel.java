...
public class Pay_ItemTravel extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_bayar_konfirmasi) {
            Intent intentSearchFlight = new Intent(Pay_ItemTravel.this, Home.class);
